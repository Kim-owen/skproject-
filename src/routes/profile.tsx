      ...
      <div className="mx-auto max-w-5xl px-4 py-10 space-y-8 font-sans">
        ...
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as any)} className="w-full">
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 rounded-2xl bg-card p-1.5 border shadow-sm mb-8 gap-1">
            <TabsTrigger
              value="overview"
              className="rounded-xl text-xs font-bold uppercase tracking-wider transition-all gap-2"
            >
                  ...
                  <div className="divide-y divide-border/60">
                    {transactions.map((tx: any) => (
                      <div key={tx.id} className="flex items-center justify-between py-3">
                        ...
                        <span
                          className={`font-mono text-sm font-bold ${tx.type === "deposit" || tx.type === "refund" ? "text-emerald-400" : "text-foreground"}`}
                        >
            ...
            {orders.length === 0 ? (
              <div className="rounded-2xl border bg-card p-12 text-center space-y-4">
                ...
                <p className="text-xs text-muted-foreground max-w-sm mx-auto">
                  Explore our delicious Ghanaian food catalog and place your first order today!
                </p>
                <Button
                  asChild
              ...
              <div className="space-y-4">
                {orders.map((o: any) => (
                  <div
                    key={o.id}
                    className="rounded-2xl border bg-card p-6 shadow-sm space-y-4 transition-all hover:border-amber-500/40"
                  >
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-border/60 pb-4">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          ...
                          <strong className="uppercase text-foreground">{o.payment_method}</strong>{" "}
                          ({o.payment_status})
                        </p>
                      </div>
                    ...
                    {o.uber_tracking_url && (
                      <div className="flex items-center justify-between rounded-xl border border-purple-500/30 bg-purple-500/10 p-3 text-xs text-purple-300">
                        <span>
                          🚀 Order is out for delivery via {o.dispatch_partner || "Rider"}
                        </span>
                        <a
            ...
            <div className="rounded-3xl border border-amber-500/30 bg-gradient-to-r from-amber-500/10 via-zinc-950 to-card p-6 md:p-8 shadow-xl space-y-6">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border/60 pb-6">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Manage your recurring meal subscriptions, upcoming scheduled delivery slots, and
                    auto-deliveries.
                  </p>
                </div>
              ...
              0 ? (
                <div className="rounded-2xl border border-dashed border-border bg-card p-10 text-center space-y-3">
                  ...
                  <h3 className="font-display text-base font-bold text-foreground">
                    No active subscriptions or scheduled orders yet
                  </h3>
                  <p className="text-xs text-muted-foreground max-w-md mx-auto">
                    You can schedule any food or provision order for a future date or subscribe for
                    weekly/monthly auto-deliveries with 10% auto-savings at checkout!
                  </p>
                  <Button
                    asChild
                    size="sm"
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  {orders
                    ...
                    .map((o: any) => (
                      <div
                        key={o.id}
                        className="rounded-2xl border border-amber-500/30 bg-card p-5 space-y-4 shadow-md"
                      >
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="rounded-2xl border bg-card p-6 shadow-sm space-y-6">
                ...
                <form onSubmit={handleSaveProfile} className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="prof-phone" className="text-xs font-bold">
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="prof-address" className="text-xs font-bold">
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    <div className="space-y-1.5">
                      <Label htmlFor="prof-gps" className="text-xs font-bold">
                        Ghana Post GPS Code
                      </Label>
                      <Input
                        id="prof-gps"
                    ...
                    <div className="space-y-1.5">
                      <Label htmlFor="prof-coords" className="text-xs font-bold">
                  ...
                  <Button
                    type="submit"
                    disabled={saving}
                    className="w-full rounded-xl bg-amber-500 hover:bg-amber-600 text-black font-extrabold py-5"
                  >
              ...
              <div className="space-y-6">
                <div className="rounded-2xl border bg-card p-6 shadow-sm space-y-4">
                  ...
                  <form onSubmit={handleChangePassword} className="space-y-4">
                    ...
                    <div className="space-y-1.5">
                      <Label htmlFor="confirm-new-pass" className="text-xs font-bold">
                ...
                <div className="rounded-2xl border bg-card p-6 shadow-sm space-y-4">
                  ...
                  <Button
                    ...
                    className="w-full rounded-xl bg-red-500/15 border border-red-500/40 text-red-400 hover:bg-red-500/25 font-extrabold text-xs gap-2 py-5"
                  >
