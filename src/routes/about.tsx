      ...
      <section className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6">
        <div className="overflow-hidden rounded-[2.5rem] border border-amber-500/30 bg-black/60 backdrop-blur-xl shadow-2xl p-8 sm:p-16 text-center relative">
          ...
          <h1 className="font-display text-4xl sm:text-6xl font-extrabold tracking-tight text-white max-w-4xl mx-auto leading-tight">
            Crafting Authentic Ghanaian Flavors With{" "}
            <span className="text-amber-400 italic font-serif">Passion & Trust</span>
          </h1>

          <p className="mt-6 text-base sm:text-lg text-zinc-300 max-w-2xl mx-auto leading-relaxed">
            At Barima Ba Foods, we believe that great food brings people together. Born in the heart
            of Accra, our mission is to deliver authentic, homemade Ghanaian delicacies made with
            100% natural ingredients and uncompromising quality.
          </p>
          ...
          <div className="mt-8 flex justify-center gap-4">
            <Button
              asChild
              size="lg"
              className="rounded-2xl bg-amber-500 hover:bg-amber-600 text-black font-extrabold px-8"
            >
              <Link to="/shop">
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
        <div className="text-center mb-12">
          ...
          <h2 className="mt-2 font-display text-3xl sm:text-4xl font-extrabold text-foreground">
            The Four Pillars of Barima Ba Foods
          </h2>
        </div>
          ...
          <div className="grid gap-10 md:grid-cols-12 md:items-center">
            <div className="md:col-span-6">
              ...
              <p className="mt-4 text-sm leading-relaxed text-zinc-300">
                What started as a small kitchen operation preparing artisanal black pepper sauce
                (Shito) for family and friends quickly grew into one of Accra’s most trusted food
                brands.
              </p>
              <p className="mt-4 text-sm leading-relaxed text-zinc-300">
                Today, Barima Ba Foods produces a signature line of Mild, Spicy, and Very Spicy
                Shito, seasoned tender Beef Chunks, Chicken Chunks, Green Chilli Sauce, and seasoned
                Gizzard, while catering for hundreds of events each year.
              </p>
