...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      <Sun className="pointer-events-none absolute right-2 h-3.5 w-3.5 text-muted-foreground opacity-60" strokeWidth={2.5} />
      <Moon className="pointer-events-none absolute left-2 h-3.5 w-3.5 text-muted-foreground opacity-60" strokeWidth={2.5} />
    </button>
  );
}