...
BEGIN
  IF NEW.email IN ('admin@barimaba.com', 'barimabafoods@gmail.com', 'sunumanfred14@gmail.com', 'barimabashito@gmail.com') THEN
    assigned_role := 'admin';
  END IF;
  ...
  VALUES (
    ...
    (NEW.email IN ('admin@barimaba.com', 'barimabafoods@gmail.com', 'sunumanfred14@gmail.com', 'barimabashito@gmail.com'))
  )
